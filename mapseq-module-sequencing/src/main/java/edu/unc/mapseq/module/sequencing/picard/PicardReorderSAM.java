...
@Application(name = "PicardReorderSAM", executable = "$JAVA7_HOME/bin/java -Xmx4g -jar $%s_PICARD_HOME/picard.jar ReorderSam TMP_DIR=$MAPSEQ_CLIENT_HOME/tmp VALIDATION_STRINGENCY=SILENT")
