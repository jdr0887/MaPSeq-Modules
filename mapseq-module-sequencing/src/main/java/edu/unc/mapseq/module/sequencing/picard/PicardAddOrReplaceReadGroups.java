...
@Application(name = "PicardAddOrReplaceReadGroups", executable = "$JAVA7_HOME/bin/java -Xmx4g -jar $%s_PICARD_HOME/picard.jar AddOrReplaceReadGroups TMP_DIR=$MAPSEQ_CLIENT_HOME/tmp VALIDATION_STRINGENCY=SILENT RGDS=GENERATED_BY_MAPSEQ")
