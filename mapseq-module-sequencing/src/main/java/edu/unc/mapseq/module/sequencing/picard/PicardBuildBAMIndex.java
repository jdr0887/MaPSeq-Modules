...
@Application(name = "PicardBuildBAMIndex", executable = "$JAVA7_HOME/bin/java -Xmx4g -jar $%s_PICARD_HOME/picard.jar BuildBAMIndex TMP_DIR=$MAPSEQ_CLIENT_HOME/tmp VALIDATION_STRINGENCY=SILENT")
